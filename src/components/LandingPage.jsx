...
import { FaBible, FaHandsHelping, FaRegSmile } from "react-icons/fa";
...
const LandingPage = ({ toggleAuthModal }) => {
	return (
		<div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 min-h-screen text-white flex flex-col">
			{/* Hero Section */}
			<header className="text-center py-16 px-6 sm:px-4">
				<motion.h1
				...
				<motion.button
					className="w-full sm:w-auto px-8 py-4 bg-white text-indigo-700 font-bold rounded-full shadow-lg hover:bg-gray-100 transition duration-300"
			...
			<section className="py-16 bg-white text-gray-800">
				<div className="container max-w-7xl mx-auto px-6 sm:px-4">
					<h2 className="text-center text-3xl md:text-4xl font-bold mb-12 text-indigo-700">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
						{features.map((feature, index) => (
							<motion.div
								...
								viewport={{ once: true }}>
								{feature.icon}
								<h3 className="text-xl md:text-2xl font-bold mt-6 text-indigo-700">
									{feature.title}
								</h3>
			...
			<section className="py-16 bg-gradient-to-r from-purple-700 via-indigo-700 to-purple-700">
				<div className="container max-w-7xl mx-auto px-6 sm:px-4 text-center text-white">
			...
			<section className="py-16 bg-indigo-500 text-center">
				...
				<motion.button
					className="w-fit sm:w-auto px-8 py-4 bg-white text-indigo-700 font-bold rounded-full shadow-lg hover:bg-gray-100 transition duration-300"
					onClick={toggleAuthModal}
					whileHover={{ scale: 1.1 }}
					whileTap={{ scale: 0.9 }}>
					Join Now
